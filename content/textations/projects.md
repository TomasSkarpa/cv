...
Educational web app · Geography · Open source (GPL-3.0)

Live app · GitHub: github.com/TomasSkarpa/flagged-it
...
Description: Learn countries through fun guessing games. Learn about countries playing different game modes: guessing games, flag recognition, shape identification, hangman, facts, and more.
...
Go · Svelte · Geography · Quiz · Web application
...
Salesforce B2C Commerce Cloud · XML · JavaScript
...
Context: Leaders of Tomorrow Program Bata Group 2025 and the LOT Conference in Prague needed an interactive activity tied to the 1940s Bata shoemaker theme. Part of broader Baťa event work alongside Bata Children's Program volunteering and Zlín Film Festival stand organization.
...
Python · Flask · Google Gemini AI · HTML · QR codes · ImgBB
...
Stack · CV · Professional approach · Recommendations
